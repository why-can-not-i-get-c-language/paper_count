...
static void OLED_GetFont(char character, const uint8_t **font)
{
    ...
    static const uint8_t oled_text[][5] = {
        {0x3EU, 0x41U, 0x41U, 0x41U, 0x3EU}, {0x7FU, 0x09U, 0x09U, 0x09U, 0x01U},
        {0x7FU, 0x49U, 0x49U, 0x49U, 0x41U}, {0x7FU, 0x40U, 0x40U, 0x40U, 0x40U},
        {0x7FU, 0x08U, 0x08U, 0x08U, 0x7FU}, {0x7FU, 0x49U, 0x49U, 0x49U, 0x36U}
    };
